...
if (NOT ignition-math2_FOUND)
  ...
  set(IGNITION-MATH_REQUIRED_MAJOR_VERSION ${ignition-math2_VERSION_MAJOR})
  message(STATUS "Looking for ignition-math${IGNITION-MATH_REQUIRED_MAJOR_VERSION}-config.cmake - found")
  message(STATUS "DIRS: ${IGNITION-MATH_DIRS}")
  message(STATUS "LIBRARY_DIRS: ${IGNITION-MATH_LIBRARY_DIRS}")
  message(STATUS "LIBRARIES: ${IGNITION-MATH_LIBRARIES}")
  list(GET IGNITION-MATH-LIBRARIES 0 FOO)
  message(STATUS "LIBRARIES*: ${FOO}")
endif()
