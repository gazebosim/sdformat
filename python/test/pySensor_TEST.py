...
from sdformat import AirPressure, Altimeter, Camera, IMU, ForceTorque, Lidar, Magnetometer, NavSat, Noise, SemanticPose, Sensor
import unittest
...
class SensorTEST(unittest.TestCase):
  ...
  def test_mutable_sensors(self):
    ...
    self.assertAlmostEqual(sensor.air_pressure_sensor().reference_altitude(), 2.0)
    ...
    self.assertAlmostEqual(navMutable.horizontal_position_noise().mean(), 2.0)
    self.assertAlmostEqual(
