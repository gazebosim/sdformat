...
class PbrTEST(unittest.TestCase):
    ...
    def test_default_construction(self):
        pbr = Pbr()
        self.assertEqual(None, pbr.workflow(PbrWorkflow.PbrWorkflowType.METAL))
        self.assertEqual(None, pbr.workflow(PbrWorkflow.PbrWorkflowType.SPECULAR))

        workflow = PbrWorkflow()
        self.assertEqual(PbrWorkflow.PbrWorkflowType.NONE, workflow.type())
        self.assertEqual('', workflow.albedo_map())
        self.assertEqual('', workflow.normal_map())
        self.assertEqual(Pbr.NormalMapSpace.TANGENT, workflow.normal_map_type())
    ...
    def test_assignment(self):
        ...
        self.assertEqual(workflow, pbr.workflow(PbrWorkflow.PbrWorkflowType.METAL))
        self.assertEqual(None, pbr.workflow(PbrWorkflow.PbrWorkflowType.SPECULAR))

        pbr2 = Pbr()
        pbr2 = pbr
        self.assertEqual(workflow, pbr2.workflow(PbrWorkflow.PbrWorkflowType.METAL))
        self.assertEqual(None, pbr2.workflow(PbrWorkflow.PbrWorkflowType.SPECULAR))

        # metal workflow
        workflow = PbrWorkflow()
        workflow.set_type(PbrWorkflow.PbrWorkflowType.METAL)
        workflow.set_albedo_map("metal_albedo_map.png")
        workflow.set_normal_map("metal_normal_map.png", Pbr.NormalMapSpace.TANGENT)
        ...
        workflow2 = workflow
        self.assertEqual(PbrWorkflow.PbrWorkflowType.METAL, workflow2.type())
        self.assertEqual("metal_albedo_map.png", workflow2.albedo_map())
        self.assertEqual("metal_normal_map.png", workflow2.normal_map())
        self.assertEqual(Pbr.NormalMapSpace.TANGENT, workflow2.normal_map_type())
        ...
        workflow2 = workflow
        self.assertEqual(PbrWorkflow.PbrWorkflowType.SPECULAR, workflow2.type())
    ...
    def test_set(self):
        ...
        workflow = PbrWorkflow()
        workflow.set_type(PbrWorkflow.PbrWorkflowType.METAL)
        self.assertEqual(PbrWorkflow.PbrWorkflowType.METAL, workflow.type())
        ...
        workflow = PbrWorkflow()
        workflow.set_type(PbrWorkflow.PbrWorkflowType.SPECULAR)
        self.assertEqual(PbrWorkflow.PbrWorkflowType.SPECULAR, workflow.type())

        workflow.set_albedo_map("specular_albedo_map.png")
        self.assertEqual("specular_albedo_map.png", workflow.albedo_map())

        workflow.set_normal_map("specular_normal_map.png",
            Pbr.NormalMapSpace.OBJECT)
        self.assertEqual("specular_normal_map.png", workflow.normal_map())
        self.assertEqual(Pbr.NormalMapSpace.OBJECT, workflow.normal_map_type())
