...
const auto g_testPath = gz::common::testing::TestFile();
const auto g_modelsPath = gz::common::testing::TestFile("integration", "model");
const auto g_sdfPath = gz::common::testing::TestFile("sdf");
