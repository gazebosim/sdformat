...
TEST(DOMActor, DefaultConstruction)
{
  ...
  EXPECT_EQ(ignition::math::Pose3d::Zero, actor.PoseRaw());
...
TEST(DOMActor, CopyConstructor)
{
  ...
  actor.SetPoseRaw({3, 2, 1, 0, IGN_PI, 0});
  ...
  EXPECT_EQ(ignition::math::Pose3d(3, 2, 1, 0, IGN_PI, 0), actor2.PoseRaw());
...
TEST(DOMActor, CopyAssignmentAfterMove)
{
  ...
  actor1.SetPoseRaw({3, 2, 1, 0, IGN_PI, 0});
  ...
  actor2.SetPoseRaw({1, 2, 3, 0, IGN_PI, 0});
  ...
  EXPECT_EQ(ignition::math::Pose3d(1, 2, 3, 0, IGN_PI, 0), actor1.PoseRaw());
  EXPECT_EQ(ignition::math::Pose3d(3, 2, 1, 0, IGN_PI, 0), actor2.PoseRaw());
