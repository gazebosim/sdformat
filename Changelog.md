...
1. Implement SDFormat 1.8 Model Composition.
    ...
    * [Pull request #518](https://github.com/ignitionrobotics/sdformat/pull/518)
    * [Pull request #504](https://github.com/ignitionrobotics/sdformat/pull/504)
...
1. Implement SDFormat 1.8 Interface API
    * [Pull request #475](https://github.com/ignitionrobotics/sdformat/pull/475)
...
1. Store include info in Element
    * [Pull request #509](https://github.com/ignitionrobotics/sdformat/pull/509)

1. Updated loading //material colors
    * [Pull request #519](https://github.com/ignitionrobotics/sdformat/pull/519)

1. Include file path and line number in parsing errors
    * [Pull request #512](https://github.com/ignitionrobotics/sdformat/pull/512)

1. Error when delimiter "::" found in element name in SDFormat 1.8
    * [Pull request #515](https://github.com/ignitionrobotics/sdformat/pull/515)
...
1. Fix lidar resolution description about interpolation
    * [Pull request #506](https://github.com/ignitionrobotics/sdformat/pull/506)

1. Added issue & PR templates
    * [Pull request #486](https://github.com/ignitionrobotics/sdformat/pull/486)
...
1. Quietly search for urdfdom
    * [Pull request #493](https://github.com/ignitionrobotics/sdformat/pull/493)

1. tests: Ensure removed SDFormat elements raise errors in newer versions
    * [Pull request #490](https://github.com/ignitionrobotics/sdformat/pull/490)

1. sdformat.pc.in: requires ignition-utils1
    * [Pull request #489](https://github.com/ignitionrobotics/sdformat/pull/489)
    * [Pull request #503](https://github.com/ignitionrobotics/sdformat/pull/503)

1. Wrap description tags in CDATA
    * [Pull request #483](https://github.com/ignitionrobotics/sdformat/pull/483)

1. Fix temperature gradient default value in Atmosphere DOM
    * [Pull request #482](https://github.com/ignitionrobotics/sdformat/pull/482)

1. Add laser_retro in Visual
    * [Pull request #454](https://github.com/ignitionrobotics/sdformat/pull/454)

1. Add Windows installation
    * [Pull request #463](https://github.com/ignitionrobotics/sdformat/pull/463)

1. Replace PROJECT_SOURCE_DIR in tests
    * [Pull request #460](https://github.com/ignitionrobotics/sdformat/pull/460)
